...
export enum I18nErrorKeys {
  ...
  GET_PRE_URL_FAILED = 'error.GET_PRE_URL_FAILED',
  ...
  // Link Password
  LINK_PASSWORD_INVALID = 'error.LINK_PASSWORD_INVALID',

  // Link Errors
  LINK_ALIAS_EXISTS = 'error.LINK_ALIAS_EXISTS',
  LINK_NOT_FOUND = 'error.LINK_NOT_FOUND',
  LINK_EXPIRED = 'error.LINK_EXPIRED',
  LINK_INACTIVE = 'error.LINK_INACTIVE',
  LINK_MAX_CLICKS_REACHED = 'error.LINK_MAX_CLICKS_REACHED',
  LINK_PERMISSION_DENIED = 'error.LINK_PERMISSION_DENIED',
  LINK_REFERRER_NOT_FOUND = 'error.LINK_REFERRER_NOT_FOUND',
...
export enum I18nMailKeys {
  ...
  // Khóa mới cho email xác minh
  VERIFY_EMAIL_SUBJECT = 'mail.VERIFY_EMAIL_SUBJECT',
  VERIFY_EMAIL_EXPIRATION = 'mail.VERIFY_EMAIL_EXPIRATION',
  VERIFY_EMAIL_GREETING = 'mail.VERIFY_EMAIL_GREETING',
  VERIFY_EMAIL_MESSAGE = 'mail.VERIFY_EMAIL_MESSAGE',
  VERIFY_EMAIL_BUTTON = 'mail.VERIFY_EMAIL_BUTTON',
  VERIFY_EMAIL_EXPIRY_NOTE = 'mail.VERIFY_EMAIL_EXPIRY_NOTE',
  VERIFY_EMAIL_IGNORE = 'mail.VERIFY_EMAIL_IGNORE',
}
